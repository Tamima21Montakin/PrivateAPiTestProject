 ...
 */
export const versions = (ids, version) => ids.reduce((dict, id) => {
    dict[id] = version;
    return dict;
}, {});
/**
 ...
 */
export const items = (fields, values) => fields.map((key, index) => ({ [key]: values[index] }));
/**
 *  Perform a read request
 *
 * @param req - the request body
 */
export const readRequest = async (req) => {
    try {
